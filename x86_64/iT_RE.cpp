...
#define nrn_init _nrn_init__it_re
#define _nrn_initial _nrn_initial__it_re
#define nrn_cur _nrn_cur__it_re
#define _nrn_current _nrn_current__it_re
#define nrn_jacob _nrn_jacob__it_re
#define nrn_state _nrn_state__it_re
#define _net_receive _net_receive__it_re 
#define castate castate__it_re 
#define evaluate_fct evaluate_fct__it_re 
...
#define phi_m _ml->template fpfield<13>(_iml)
#define phi_m_columnindex 13
#define phi_h _ml->template fpfield<14>(_iml)
#define phi_h_columnindex 14
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"setdata_it_re", _hoc_setdata},
 {"evaluate_fct_it_re", _hoc_evaluate_fct},
 {0, 0}
};
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"phi_m"} /* 13 */,
                                       _nrn_mechanism_field<double>{"phi_h"} /* 14 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 it_re /Users/scoot/TC_sleepnet/mod/iT_RE.mod\n");
...
static int _reset;
static const char *modelname = "Low threshold calcium current for RE cells";
...
static int  evaluate_fct ( _internalthreadargsprotocomma_ double _lv ) {
   m_inf = 1.0 / ( 1.0 + exp ( - ( _lv + 52.0 ) / 7.4 ) ) ;
   h_inf = 1.0 / ( 1.0 + exp ( ( _lv + 80.0 ) / 5.0 ) ) ;
   tau_m = ( 3.0 + 1.0 / ( exp ( ( _lv + 27.0 ) / 10.0 ) + exp ( - ( _lv + 102.0 ) / 15.0 ) ) ) / phi_m ;
   tau_h = ( 85.0 + 1.0 / ( exp ( ( _lv + 48.0 ) / 4.0 ) + exp ( - ( _lv + 407.0 ) / 50.0 ) ) ) / phi_h ;
    return 0; }
...
static void _hoc_evaluate_fct(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for evaluate_fct_it_re. Requires prior call to setdata_it_re and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/scoot/TC_sleepnet/mod/iT_RE.mod";

...
#define nrn_init _nrn_init__kdr_tc
#define _nrn_initial _nrn_initial__kdr_tc
#define nrn_cur _nrn_cur__kdr_tc
#define _nrn_current _nrn_current__kdr_tc
#define nrn_jacob _nrn_jacob__kdr_tc
#define nrn_state _nrn_state__kdr_tc
#define _net_receive _net_receive__kdr_tc 
#define rates rates__kdr_tc 
#define states states__kdr_tc 
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"setdata_kdr_tc", _hoc_setdata},
 {"rates_kdr_tc", _hoc_rates},
 {"vtrap_kdr_tc", _hoc_vtrap},
 {0, 0}
};
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 kdr_tc /Users/scoot/TC_sleepnet/mod/kdr_tc.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "kdr_tc.mod";
...
static int  rates ( _internalthreadargsprotocomma_ double _lv ) {
  ...
  _la = 0.032 * vtrap ( _threadargscomma_ - ( _lv + 13.0 ) , 5.0 ) ;
   _lb = 0.5 * exp ( - ( _lv + 18.0 ) / 40.0 ) ;
   _lsum = _la + _lb ;
   ntau = 1.0 / _lsum ;
   ninf = _la / _lsum ;
    return 0; }
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_kdr_tc. Requires prior call to setdata_kdr_tc and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/scoot/TC_sleepnet/mod/kdr_tc.mod";

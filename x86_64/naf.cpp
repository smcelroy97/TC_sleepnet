 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 naf /Users/scoot/TC_sleepnet/mod/naf.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "naf.mod";
...
static int  rates ( _internalthreadargsprotocomma_ double _lv ) {
  ...
  _la = 0.182 * vtrap ( _threadargscomma_ - ( _lv + 25.0 ) , 9.0 ) ;
   _lb = 0.124 * vtrap ( _threadargscomma_ _lv + 25.0 , 9.0 ) ;
   _lsum = _la + _lb ;
   mtau = 0.3386521313023745 / _lsum ;
   minf = _la / _lsum ;
   hinf = 1.0 / ( 1.0 + exp ( ( _lv + 55.0 ) / 6.2 ) ) ;
   _lc = 0.024 * vtrap ( _threadargscomma_ - ( _lv + 40.0 ) , 5.0 ) ;
   _ld = 0.0091 * vtrap ( _threadargscomma_ _lv + 65.0 , 5.0 ) ;
   htau = 0.3386521313023745 / ( _lc + _ld ) ;
    return 0; }
...
{ {
   gna = gnabar * m * m * m * h ;
   ina = 2.952882641412121 * gna * ( v - ena ) ;
   }
 _current += ina;
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/scoot/TC_sleepnet/mod/naf.mod";

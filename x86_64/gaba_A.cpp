...
#define nrn_init _nrn_init__GABA_A
#define _nrn_initial _nrn_initial__GABA_A
#define nrn_cur _nrn_cur__GABA_A
#define _nrn_current _nrn_current__GABA_A
#define nrn_jacob _nrn_jacob__GABA_A
#define nrn_state _nrn_state__GABA_A
#define _net_receive _net_receive__GABA_A 
#define release release__GABA_A 
...
#define synon _ml->template fpfield<6>(_iml)
#define synon_columnindex 6
#define DRon _ml->template fpfield<7>(_iml)
#define DRon_columnindex 7
#define DRoff _ml->template fpfield<8>(_iml)
#define DRoff_columnindex 8
#define _g _ml->template fpfield<9>(_iml)
#define _g_columnindex 9
#define _tsav _ml->template fpfield<10>(_iml)
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 #define gind 0
 #define _gth 0
#define Alpha Alpha_GABA_A
 double Alpha = 10.5;
#define Beta Beta_GABA_A
 double Beta = 0.166;
#define Cmax Cmax_GABA_A
 double Cmax = 0.5;
#define Cdur Cdur_GABA_A
 double Cdur = 0.3;
#define Rtau Rtau_GABA_A
 double Rtau = 0;
#define Rinf Rinf_GABA_A
 double Rinf = 0;
#define deadtime deadtime_GABA_A
 double deadtime = 1;
 ...
 {"Cdur_GABA_A", &Cdur_GABA_A},
 {"deadtime_GABA_A", &deadtime_GABA_A},
 {"Cmax_GABA_A", &Cmax_GABA_A},
 {"Alpha_GABA_A", &Alpha_GABA_A},
 {"Beta_GABA_A", &Beta_GABA_A},
 {"Rtau_GABA_A", &Rtau_GABA_A},
 {"Rinf_GABA_A", &Rinf_GABA_A},
 {0, 0}
};
  ...
  if (nrn_point_prop_) {
   ...
   _ppvar = nrn_prop_datum_alloc(_mechtype, 4, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 11);
 	...
 	gmax = _parm_default[0]; /* 0.2 */
 	Erev = _parm_default[1]; /* -70 */
  }
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 11);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"synon"} /* 6 */,
                                       _nrn_mechanism_field<double>{"DRon"} /* 7 */,
                                       _nrn_mechanism_field<double>{"DRoff"} /* 8 */,
                                       _nrn_mechanism_field<double>{"_g"} /* 9 */,
                                       _nrn_mechanism_field<double>{"_tsav"} /* 10 */,
 ...
 pnt_receive_size[_mechtype] = 4;
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 GABA_A /Users/scoot/TC_sleepnet/mod/gaba_A.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "gaba_A.mod";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/scoot/TC_sleepnet/mod/gaba_A.mod";

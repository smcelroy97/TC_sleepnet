...
#define t _nt->_t
#define dt _nt->_dt
#define gkcabar _ml->template fpfield<0>(_iml)
#define gkcabar_columnindex 0
#define minf _ml->template fpfield<1>(_iml)
#define minf_columnindex 1
#define mtau _ml->template fpfield<2>(_iml)
...
#define gkca _ml->template fpfield<6>(_iml)
#define gkca_columnindex 6
  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 6, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 11);
 	...
 	gkcabar = _parm_default[0]; /* 0.0003 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 11);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       _nrn_mechanism_field<double>{"gkcabar"} /* 0 */,
                                       _nrn_mechanism_field<double>{"minf"} /* 1 */,
                                       _nrn_mechanism_field<double>{"mtau"} /* 2 */,
                                       _nrn_mechanism_field<double>{"m"} /* 3 */,
                                       _nrn_mechanism_field<double>{"ek"} /* 4 */,
                                       _nrn_mechanism_field<double>{"Dm"} /* 5 */,
                                       _nrn_mechanism_field<double>{"gkca"} /* 6 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 kca /Users/scoot/TC_sleepnet/mod/kca.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "kca.mod";
...
static int  rates ( _internalthreadargsprotocomma_ double _lcai ) {
    minf = _lcai / ( _lcai + 2.0 ) ;
   mtau = 33.86521313023745 / ( _lcai + 2.0 ) ;
     return 0; }
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_kca. Requires prior call to setdata_kca and that the specified mechanism instance still be in existence.", NULL);
  }
...
{ {
   gkca = gkcabar * m ;
   ik = 2.952882641412121 * gkca * ( v - ek ) ;
   }
 _current += ik;
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/scoot/TC_sleepnet/mod/kca.mod";

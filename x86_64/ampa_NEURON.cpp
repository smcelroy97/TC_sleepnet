...
#define nrn_init _nrn_init__AMPA_NEURON
#define _nrn_initial _nrn_initial__AMPA_NEURON
#define nrn_cur _nrn_cur__AMPA_NEURON
#define _nrn_current _nrn_current__AMPA_NEURON
#define nrn_jacob _nrn_jacob__AMPA_NEURON
#define nrn_state _nrn_state__AMPA_NEURON
#define _net_receive _net_receive__AMPA_NEURON 
#define release release__AMPA_NEURON 
...
#define i _ml->template fpfield<0>(_iml)
#define i_columnindex 0
#define g _ml->template fpfield<1>(_iml)
#define g_columnindex 1
#define Ron _ml->template fpfield<2>(_iml)
#define Ron_columnindex 2
#define Roff _ml->template fpfield<3>(_iml)
#define Roff_columnindex 3
#define synon _ml->template fpfield<4>(_iml)
#define synon_columnindex 4
#define DRon _ml->template fpfield<5>(_iml)
#define DRon_columnindex 5
#define DRoff _ml->template fpfield<6>(_iml)
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 #define gind 0
 #define _gth 0
#define Alpha Alpha_AMPA_NEURON
 double Alpha = 1.1;
#define Beta Beta_AMPA_NEURON
 double Beta = 0.19;
#define Cdur Cdur_AMPA_NEURON
 double Cdur = 0.3;
#define Erev Erev_AMPA_NEURON
 double Erev = 0;
#define Rtau Rtau_AMPA_NEURON
 double Rtau = 0;
#define Rinf Rinf_AMPA_NEURON
 double Rinf = 0;
 ...
 {"Cdur_AMPA_NEURON", &Cdur_AMPA_NEURON},
 {"Alpha_AMPA_NEURON", &Alpha_AMPA_NEURON},
 {"Beta_AMPA_NEURON", &Beta_AMPA_NEURON},
 {"Erev_AMPA_NEURON", &Erev_AMPA_NEURON},
 {"Rtau_AMPA_NEURON", &Rtau_AMPA_NEURON},
 {"Rinf_AMPA_NEURON", &Rinf_AMPA_NEURON},
 {0, 0}
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 extern "C" void _ampa_NEURON_reg() {
	int _vectorized = 0;
  _initlists();
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       _nrn_mechanism_field<double>{"i"} /* 0 */,
                                       _nrn_mechanism_field<double>{"g"} /* 1 */,
                                       _nrn_mechanism_field<double>{"Ron"} /* 2 */,
                                       _nrn_mechanism_field<double>{"Roff"} /* 3 */,
                                       _nrn_mechanism_field<double>{"synon"} /* 4 */,
                                       _nrn_mechanism_field<double>{"DRon"} /* 5 */,
                                       _nrn_mechanism_field<double>{"DRoff"} /* 6 */,
 ...
 pnt_receive_size[_mechtype] = 4;
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 AMPA_NEURON /Users/scoot/TC_sleepnet/mod/ampa_NEURON.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "ampa.mod";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/scoot/TC_sleepnet/mod/ampa_NEURON.mod";

...
#define nrn_init _nrn_init__AMPA_D2
#define _nrn_initial _nrn_initial__AMPA_D2
#define nrn_cur _nrn_cur__AMPA_D2
#define _nrn_current _nrn_current__AMPA_D2
#define nrn_jacob _nrn_jacob__AMPA_D2
#define nrn_state _nrn_state__AMPA_D2
#define _net_receive _net_receive__AMPA_D2 
#define release release__AMPA_D2 
#define setrand setrand__AMPA_D2 
...
#define gen_nextpsp gen_nextpsp_AMPA_D2
#define max max_AMPA_D2
#define pick pick_AMPA_D2
 ...
 #define gind 0
 #define _gth 0
#define Alpha Alpha_AMPA_D2
 double Alpha = 1.1;
#define Beta Beta_AMPA_D2
 double Beta = 0.19;
#define Cmax Cmax_AMPA_D2
 double Cmax = 0.5;
#define Cdur Cdur_AMPA_D2
 double Cdur = 0.3;
#define Rtau Rtau_AMPA_D2
 double Rtau = 0;
#define Rinf Rinf_AMPA_D2
 double Rinf = 0;
#define SS_denom SS_denom_AMPA_D2
 double SS_denom = 250;
#define Tr Tr_AMPA_D2
 double Tr = 700;
#define afterspike_time afterspike_time_AMPA_D2
 double afterspike_time = 100;
#define deadtime deadtime_AMPA_D2
 double deadtime = 1;
#define mini_fre mini_fre_AMPA_D2
 double mini_fre = 20;
 ...
 {"Cdur_AMPA_D2", &Cdur_AMPA_D2},
 {"deadtime_AMPA_D2", &deadtime_AMPA_D2},
 {"Cmax_AMPA_D2", &Cmax_AMPA_D2},
 {"Alpha_AMPA_D2", &Alpha_AMPA_D2},
 {"Beta_AMPA_D2", &Beta_AMPA_D2},
 {"Tr_AMPA_D2", &Tr_AMPA_D2},
 {"afterspike_time_AMPA_D2", &afterspike_time_AMPA_D2},
 {"mini_fre_AMPA_D2", &mini_fre_AMPA_D2},
 {"SS_denom_AMPA_D2", &SS_denom_AMPA_D2},
 {"Rtau_AMPA_D2", &Rtau_AMPA_D2},
 {"Rinf_AMPA_D2", &Rinf_AMPA_D2},
 {0, 0}
};
  ...
  if (nrn_point_prop_) {
   ...
   _ppvar = nrn_prop_datum_alloc(_mechtype, 5, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 14);
 	...
 	psp_weight = _parm_default[1]; /* 1.5 */
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 8;
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 AMPA_D2 /Users/scoot/TC_sleepnet/mod/ampa_D2.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "ampa_D2.mod";
 ...
 v=_v;
{
 { error =  release();
 if(error){
  std_cerr_stream << "at line 71 in file ampa_D2.mod:\nBREAKPOINT { \n";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/scoot/TC_sleepnet/mod/ampa_D2.mod";

...
#define mtau _ml->template fpfield<1>(_iml)
#define mtau_columnindex 1
  ...
  Datum *_ppvar{};
   _ppvar = nrn_prop_datum_alloc(_mechtype, 4, _prop);
    ...
    assert(_nrn_mechanism_get_num_vars(_prop) == 10);
 	...
 	gnabar = _parm_default[0]; /* 7e-05 */
 	mtau = _parm_default[1]; /* 0.19915 */
 	 assert(_nrn_mechanism_get_num_vars(_prop) == 10);
 	_nrn_mechanism_access_dparam(_prop) = _ppvar;
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"mtau"} /* 1 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 nap /Users/scoot/TC_sleepnet/mod/nap.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "nap.mod";
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_nap. Requires prior call to setdata_nap and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/scoot/TC_sleepnet/mod/nap.mod";

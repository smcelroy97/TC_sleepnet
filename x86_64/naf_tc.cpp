...
#define nrn_init _nrn_init__naf_tc
#define _nrn_initial _nrn_initial__naf_tc
#define nrn_cur _nrn_cur__naf_tc
#define _nrn_current _nrn_current__naf_tc
#define nrn_jacob _nrn_jacob__naf_tc
#define nrn_state _nrn_state__naf_tc
#define _net_receive _net_receive__naf_tc 
#define rates rates__naf_tc 
#define states states__naf_tc 
...
#define ina _ml->template fpfield<11>(_iml)
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"setdata_naf_tc", _hoc_setdata},
 {"rates_naf_tc", _hoc_rates},
 {"vtrap_naf_tc", _hoc_vtrap},
 {0, 0}
};
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"ina"} /* 11 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 naf_tc /Users/scoot/TC_sleepnet/mod/naf_tc.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "naf_tc.mod";
...
static int  rates ( _internalthreadargsprotocomma_ double _lv ) {
   double _la , _lb , _lsum ;
  _la = 0.32 * vtrap ( _threadargscomma_ - ( _lv + 27.0 ) , 4.0 ) ;
   _lb = 0.28 * vtrap ( _threadargscomma_ _lv + 0.0 , 5.0 ) ;
   _lsum = _la + _lb ;
   mtau = 1.0 / _lsum ;
   minf = _la / _lsum ;
   _la = 0.128 * exp ( - ( _lv + 23.0 ) / 18.0 ) ;
   _lb = 4.0 / ( exp ( - ( _lv + 0.0 ) / 5.0 ) + 1.0 ) ;
   _lsum = _la + _lb ;
   htau = 1.0 / _lsum ;
   hinf = _la / _lsum ;
    return 0; }
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_naf_tc. Requires prior call to setdata_naf_tc and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/scoot/TC_sleepnet/mod/naf_tc.mod";
    const char* nmodl_file_text = 
  "TITLE naf_tc.mod\n"
  " \n"
  "COMMENT\n"
  " Fast sodium current for RE and TC cells that was supposed to be defined in appendix of  Bazhenov 1998 (doi: https://doi.org/10.1152/jn.1998.79.5.2730), and referenced in \n"
  ...
  "        a = 0.32 * vtrap(-(v+27),4) :for RE cell, it should be 37 (instead of 27) in order to match C++ code (around line 1500 of neur271.c)\n"
  "        b =  0.28 * vtrap(v+0,5) :for RE cell, it should be 10 (instead of 0) in order to match C++ code (around line 1500 of neur271.c)\n"
  "        sum = a + b\n"
  "	mtau = 1.0/sum\n"
  "        minf = a/sum\n"
  "                :\"h\" sodium inactivation system\n"
  "        \n"
  "        a = 0.128*exp(-(v+23)/18) :for RE cell, it should be 33 (instead of 23) in order to match C++ code (around line 1500 of neur271.c)\n"
  "        b = 4/(exp(-(v+0)/5) + 1) :for RE cell, it should be 10 (instead of 0) in order to match C++ code (around line 1500 of neur271.c)\n"
  "        sum = a + b\n"
  "	htau = 1.0/sum\n"
  "	hinf = a/sum\n"
  "        \n"

...
#define t _nt->_t
#define dt _nt->_dt
#define gkL _ml->template fpfield<0>(_iml)
#define gkL_columnindex 0
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       _nrn_mechanism_field<double>{"gkL"} /* 0 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 1, "k_ion");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 kL /Users/scoot/TC_sleepnet/mod/kL.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static const char *modelname = "kL.mod";
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/Users/scoot/TC_sleepnet/mod/kL.mod";
